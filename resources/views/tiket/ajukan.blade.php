        ...
        <form action='{{route('tiket.store')}}' method='POST'>
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 px-60 pb-10">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <select id="prioritas_id" name="prioritas_id" autocomplete="prioritas_id" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
